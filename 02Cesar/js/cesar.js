...
function cifrar(){
    ...
    document.getElementById("resultado").innerHTML = cesar.encode(document.getElementById("cadena").value, num)
}

function descifrar(){
    var num = document.getElementById("numer").value
    document.getElementById("resultado").innerHTML = cesar.decode(document.getElementById("cadena").value, num)
}